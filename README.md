...
이 프로젝트는 라즈베리 파이를 이용한 GPS 위치 추적 클라이언트와 이를 수집하고 시각화하는 서버 및 웹 애플리케이션으로 구성되어 있습니다. 웹 대시보드를 통해 자제 검색 및 위치 확인, 스마트태그 기기의 데이터 전송 주기를 설정 가능하며 자체 지도 서버(Tileserver-GL)를 운영하여 오프라인 환경에서도 지도를 서비스할 수 있습니다.
